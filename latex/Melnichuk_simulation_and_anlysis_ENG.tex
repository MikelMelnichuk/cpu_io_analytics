...
\begin{figure}[!htbp]
  ...
  \caption{Симуляционное моделирование Sim 1k, Sim 2k, Sim 5k, аналитическое вычисление (синяя сплошная линия) и экспериментально полученные данные на сервере Kubernetes (зелёные х).}
  \label{fig:Mel_fig_System_States}
\end{figure}

\begin{table}[htbp]
  \centering
  \caption{Average (across $\alpha$) -- Simulation vs Empirical and Simulation vs Analytical}
  \label{tab:average_alpha_sim_vs_emp_analytical}
  ...
  \begin{tabular}{l r r r r r r}
    \toprule
     & \multicolumn{3}{c}{Simulation vs Empirical} & \multicolumn{3}{c}{Simulation vs Analytical} \\
...
% Average (across alpha) – Simulation vs Empirical:
% Config     RMSE      MAE     MAPE
% Sim 1k 0.046517 0.034948 3.132380
% Sim 2k 0.042892 0.033014 2.973859
% Sim 5k 0.042358 0.033007 2.967847

% Average (across alpha) – Simulation vs Analytical:
% Config     RMSE      MAE     MAPE
% Sim 1k 0.020594 0.015854 1.454926
% Sim 2k 0.020005 0.014893 1.365564
% Sim 5k 0.019507 0.014632 1.337648
