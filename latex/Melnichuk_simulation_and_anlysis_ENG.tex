...
\begin{figure}[!htbp]
  ...
  \caption{Симуляционное моделирование (оранжевая линия с точками), аналитическое вычисление (синяя сплошная линия) и экспериментально полученные данные на сервере Kubernetes (зелёные х).}
